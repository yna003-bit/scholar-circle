...
function DeadlineChip({ label, tone = "urgent" }: { label: string; tone?: "urgent" | "funded" | "info" }) {
  ...
  return (
    <span
      className={`${mono.variable} inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium tracking-tight ${styles}`}
    ...
    <div className={`${display.variable} ${body.variable} ${mono.variable} bg-white`} style={{ fontFamily: "var(--font-body)" }}>
      ...
      <nav className="border-b border-slate-100">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <Link
            href="/login"
            className="rounded-full bg-[#2563EB] px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-[#1D4ED8]"
          >
            Sign in
          </Link>
        </div>
      ...
      <section className="border-y border-slate-100 bg-slate-50/60">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-6 text-center md:grid-cols-4">
            {[
              "[Add opportunities shared count]",
              "[Add students connected count]",
              "[Add funding organizations count]",
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-100 bg-white p-6">
              <p className="text-sm italic leading-relaxed text-slate-500">
                &ldquo;[Add a real testimonial once a student shares one — this is a placeholder,
                not a real quote.]&rdquo;
              </p>
              <p className="mt-4 text-xs font-medium text-slate-400">— [Student name]</p>
            </div>
            <div className="rounded-2xl border border-slate-100 bg-white p-6">
              <p className="text-sm italic leading-relaxed text-slate-500">
                &ldquo;[Add a second testimonial here once you have one.]&rdquo;
              </p>
              <p className="mt-4 text-xs font-medium text-slate-400">— [Student name]</p>
            </div>
          </div>
